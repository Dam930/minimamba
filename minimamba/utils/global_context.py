...
from minimamba.utils.exceptions import OperationNotAllowed
from minimamba.utils.logging import generate_log_name
from minimamba.utils.singleton import singleton
...
class GlobalContextManager:
    ...
    def _setup_serialization_dir(self, command_name: str) -> Path:
        ...
        path_serialization_dir = (
            Path(self._config.working_dir) / f"{command_name}-{timestamp}"
        )
